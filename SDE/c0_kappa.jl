...
function runPulse(κ)
	prob = SDEProblem(LV_model,[X₀; 0; A₀],(0.0,T),[b, d, γ, κ, α, μ, λ, m])
...
#R code to generate kappa with c=0 vs relative average bacterial load (for SI Appendix)
using RCall
@rput output
R"""
library(ggplot2)
...
save_plot(output,filename="c0_kappa.png",base_height = 2.5,base_width = 8)
"""
