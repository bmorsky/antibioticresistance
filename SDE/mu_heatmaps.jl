...
output_alwayson = 1
using RCall
@rput output_mean mymu mymuprime output_alwayson maxSwitching
R"""
library(ggplot2)
...
save_plot(p_mean,filename=paste(paste("mu",mymu,"muprime",mymuprime,sep="_"),".png", sep=""),base_height = 4,base_width = 4)
save(output_mean,file=paste(paste("mu",mymu,"muprime",mymuprime,sep="_"),".Rda", sep=""))
"""
