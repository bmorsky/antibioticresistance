...
output_alwayson = 1
using RCall
@rput output_mean myalpha output_alwayson maxSwitching
R"""
library(ggplot2)
...
ggtitle(bquote(alpha==.(myalpha)))

save_plot(p_mean,filename=paste(paste("alpha",myalpha,sep="_"),".png", sep=""),base_height = 4,base_width = 4)
save(output_mean,file=paste(paste("alpha",myalpha,sep="_"),".Rda", sep=""))
"""
