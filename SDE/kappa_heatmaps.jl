...
save_plot(p_mean,filename=paste(paste("kappa",mykappa,sep="_"),".png", sep=""),base_height = 4,base_width = 4)
save(output_mean,file=paste(paste("kappa",mykappa,sep="_"),".Rda", sep=""))
"""
